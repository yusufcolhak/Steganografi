# Steganografi Uygulaması (C# WinForms)

Bu proje, C# ve Windows Forms kullanılarak geliştirilmiş bir **Steganografi (Veri Gizleme)** uygulamasıdır. Kullanıcıların herhangi bir resim dosyasının (.png, .bmp vb.) içerisine gizli metin mesajları gömmesine (saklamasına) ve daha sonra bu resimlerden gizli mesajları tekrar okuyup çıkarmasına olanak tanır.
